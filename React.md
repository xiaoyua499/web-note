...
![](D:\Desktop\文件\web\web源码\资料-前端React精品教程\day-02\笔记\images\props-设置.png)

- 接收数据：函数组件通过 参数 props接收数据，类组件通过 this.props接收数据

  - 函数组件获取

    ![](D:\Desktop\文件\web\web源码\资料-前端React精品教程\day-02\笔记\images\函数组件获取.png)

  - 类组件获取

    ![](D:\Desktop\文件\web\web源码\资料-前端React精品教程\day-02\笔记\images\类组件获取.png)
...
![](D:\Desktop\文件\web\web源码\资料-前端React精品教程\day-02\笔记\images\类组件注意点.png)
...
![](D:\Desktop\文件\web\web源码\资料-前端React精品教程\day-02\笔记\images\父传子.png)
...
![](D:\Desktop\文件\web\web源码\资料-前端React精品教程\day-02\笔记\images\子传父-父亲设置回调.png)

- 子组件通过props调用回调函数

![](D:\Desktop\文件\web\web源码\资料-前端React精品教程\day-02\笔记\images\子传父-调用回调.png)
...
![](D:\Desktop\文件\web\web源码\资料-前端React精品教程\day-02\笔记\images\兄弟传递.png)
...
![](D:\Desktop\文件\web\web源码\资料-前端React精品教程\day-02\笔记\images\创建Context.png)

- 使用Provider 组件作为父节点

![](D:\Desktop\文件\web\web源码\资料-前端React精品教程\day-02\笔记\images\provider.png)

- 设置value属性，表示要传递的数据

![](D:\Desktop\文件\web\web源码\资料-前端React精品教程\day-02\笔记\images\设置value属性.png)

- 哪一层想要接收数据，就用Consumer进行包裹，在里面回调函数中的参数就是传递过来的值

![](D:\Desktop\文件\web\web源码\资料-前端React精品教程\day-02\笔记\images\Comsumer.png)
...
![](D:\Desktop\文件\web\web源码\资料-前端React精品教程\day-02\笔记\images\props-children.png)
...
![](D:\Desktop\文件\web\web源码\资料-前端React精品教程\day-02\笔记\images\props-校验.png)

- 作用：捕获使用组件时因为props导致的错误，给出明确的错误提示，增加组件的健壮性

![](D:\Desktop\文件\web\web源码\资料-前端React精品教程\day-02\笔记\images\props-错误提示.png)
...
![](D:\Desktop\文件\web\web源码\资料-前端React精品教程\day-02\笔记\images\propsTypes.png)
...
![](D:\Desktop\文件\web\web源码\资料-前端React精品教程\day-02\笔记\images\props-约束规则.png)

#### props的默认值

- 场景：分页组件 -> 每页显示条数

![](D:\Desktop\文件\web\web源码\资料-前端React精品教程\day-02\笔记\images\props默认值.png)
